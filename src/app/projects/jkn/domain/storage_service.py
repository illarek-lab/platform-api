...
from app.projects.jkn.domain.models.file import File
from app.projects.jkn.domain.ports import IFileRepository, IStorageClient
...
class StorageService:
    ...
    def __init__(
        self, file_repo: IFileRepository, storage_client: IStorageClient
    ) -> None:
    ...
    async def generate_upload_url(
        ...
        upload_url = await self._storage.get_upload_url(
            object_key, content_type, expires_in
        )
        return {
    ...
    async def list_files(
        ...
        return await self._repo.find_by_project_and_user(
            project_slug, user_id, limit, offset
        )
