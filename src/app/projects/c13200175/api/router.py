...
from app.projects.c13200175.api.device_tokens import router as device_tokens_router
from app.projects.c13200175.api.notifications import router as notifications_router
