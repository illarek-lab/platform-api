...
from app.projects.c22200024.api.deps import get_auth_service
...
from app.projects.c22200024.api.deps import AuthService, get_current_user
...
from app.projects.c22200024.infra.token import create_token
