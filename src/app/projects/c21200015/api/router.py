...
from app.projects.c21200015.api.device_tokens import router as device_tokens_router
from app.projects.c21200015.api.notifications import router as notifications_router
