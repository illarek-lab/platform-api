...
from app.projects.c21200096.api.device_tokens import router as device_tokens_router
from app.projects.c21200096.api.notifications import router as notifications_router
