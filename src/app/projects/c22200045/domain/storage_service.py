...
from app.projects.c22200045.domain.models.file import File
from app.projects.c22200045.domain.ports import (
    IFileRepository,
    IStorageClient,
)
...
class StorageService:
    ...
    async def delete_file(
        ...
        if (
            str(file.user_id) != user_id
            or file.project_slug != project_slug
        ):
            raise StorageAccessError
