...
from app.projects.c20200147.api.auth import router as auth_router
from app.projects.c20200147.api.geo_events import router as geo_events_router
from app.projects.c20200147.api.geo_events_orm import router as geo_events_orm_router
