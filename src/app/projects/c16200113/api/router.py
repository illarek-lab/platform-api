...
from app.projects.c16200113.api.device_tokens import router as device_tokens_router
from app.projects.c16200113.api.notifications import router as notifications_router
